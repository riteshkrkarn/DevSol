      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">
              Send SOL tokens on Solana network
            </p>
          </div>
        </div>
        {/* Main Content */}
        <div className="flex justify-center mb-8">
          <div className="group relative overflow-hidden w-full max-w-md rounded-xl sm:rounded-2xl border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-2xl p-6 bg-white dark:bg-gray-800 transition-all duration-300 transform hover:-translate-y-1">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-orange-500 to-red-600 opacity-0 group-hover:opacity-10 transition-opacity duration-300" />
                  ...
                  <WalletModalProvider>
                    <div className="flex flex-col gap-6">
                      ...
                      <div className="flex justify-center">
                        <WalletMultiButton className="!bg-gradient-to-r !from-orange-500 !to-red-600 hover:!from-orange-600 hover:!to-red-700 !rounded-lg !font-medium !shadow-lg" />
                      </div>
                    </div>
                  </WalletModalProvider>
                </WalletProvider>
